// // Add class on link clicks
// document.querySelectorAll('a:not([href^="#"])').forEach(link => {
//   link.addEventListener('click', function(e) {
//     // Exclude links that don't trigger page navigation
//     const href = link.getAttribute('href') || '';
//     if (
//       href && // Ensure href exists
//       (link.hostname === window.location.hostname || href.startsWith('/')) && // Same domain or relative URL
//       !link.hasAttribute('download') && // Not a download link
//       !link.hasAttribute('cart-drawer') && // Not a download link
//       !link.hasAttribute('account-drawer') && // Not a download link
...
// // Remove class when the new page loads
